...
public final class ActivityBmiBinding implements ViewBinding {
  ...
  private ActivityBmiBinding(@NonNull RelativeLayout rootView, @NonNull Button btnCalculateUnits,
      ...
      @NonNull AppCompatEditText etUsMetricUnitWeight, @NonNull LinearLayout llDisplayBMIResult,
    ...
    this.llDisplayBMIResult = llDisplayBMIResult;
  ...
  public static ActivityBmiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.llDisplayBMIResult;
      LinearLayout llDisplayBMIResult = ViewBindings.findChildViewById(rootView, id);
      if (llDisplayBMIResult == null) {
        break missingId;
      }
      ...
      return new ActivityBmiBinding((RelativeLayout) rootView, btnCalculateUnits,
          ...
          etUsMetricUnitHeightInch, etUsMetricUnitWeight, llDisplayBMIResult, rbMetricUnits,
