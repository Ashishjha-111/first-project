...
import eu.tutorials.a7minutesworkout.ExerciseModel
import eu.tutorials.a7minutesworkout.R
import java.util.*
    ...
    companion object {
        ...
        fun defaultExerciseList(): ArrayList<ExerciseModel> {
            ...
            val tricepsDipOnChair =
                ExerciseModel(7, "Triceps Dip On Chair", R.drawable.ic_triceps_dip_on_chair, false, false)
