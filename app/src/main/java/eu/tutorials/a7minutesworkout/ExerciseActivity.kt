...
//variable
    ...
    private fun setupRestView() {
        try {
            val soundURI =
                Uri.parse("android.resource://eu.tutorials.a7minutesworkout/" + R.raw.press_start)
    ...
    private fun customDialogForBackButton() {
        ...
        dialogBinding.tvYes.setOnClickListener {
            //Todo 6 We need to specify that we are finonishing this activity if not the player
